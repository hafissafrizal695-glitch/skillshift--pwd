...
export default function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col app-root relative" style={{ paddingTop: '180px' }}>
      ...
      {activeTab === 'profile' && (
        <div className="animate-fade-in px-4 sm:px-6 md:px-10 max-w-6xl mx-auto w-full max-w-full overflow-hidden">
